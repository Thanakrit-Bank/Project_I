...
import CalendLL from './CalendLL';
import CalendRR from './CalendRR';
import GridData from '../components/GridData';
import Legend from "../components/Legend";
import SelectDataLL from './SelectDataLL';
import SelectDataRR from './SelectDataRR';
import SelectProvinceLL from './SelectProvinceLL';
import SelectProvinceRR from './SelectProvinceRR';
...
const ComparePage = () => {
  ...
  return (
    <div>
        <Link to="/mainMap">
            <button className='map-view back'>
                Back
            </button>
        </Link>
        <div className='grid-container'>
            <div className="grid-item">
                <MapContainer className='mapcompare'
                    center={center} 
                    zoom={zoom} 
                ...
                >
                    ...
                    <SelectProvinceLL onChengeSelect= {onChangeSelectProvince}/>

                    <SelectDataLL onChengeSelect={onChangeSelectData} type = {dataIndex} indexFolder={index_folder}/>
                    ...
                    <CalendLL setDate={date} onChange={onChangeDate} dataType={dataIndex}/>
            ...
            <div className="grid-item"> 
                ...
                >
                    ...
                    <SelectProvinceRR onChengeSelect= {onChangeSelectProvince}/>

                    <SelectDataRR onChengeSelect={onChangeSelectData} type = {dataIndex} indexFolder={index_folder}/>
                    ...
                    <GridData dataIndex={dataIndex} pName={province_select} date={date} SetViewOnChange={SetViewOnChange} index_folder={index_folder} setTimeSeriesData = {getTimeSeriesData}/>
                    <Legend dataIndex = {dataIndex}/>
                    <CalendRR setDate={date} onChange={onChangeDate} dataType={dataIndex}/>
                    {/* <Logout setToken={props.setToken} token={props.token} /> */}
                    <TimeSeries data={timeSeriesData} />
                    {/* <CompareButton /> */}
                    {/* <Link to="/page2"><button className='map-view map-compare'>Compare Mode</button></Link> */}
