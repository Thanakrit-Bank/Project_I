...
function SelectProvinceRR(props) {
  return (
    <select onChange={(e) => props.onChengeSelect(e.target.value)} className='mapcompare select-province-right'>
...
export default SelectProvinceRR