...
function SelectProvinceLL(props) {
  return (
    <select onChange={(e) => props.onChengeSelect(e.target.value)} className='mapcompare select-province-left'>
...
export default SelectProvinceLL