 ...
 * the ripple effects.
 */
export declare function useRipples<E extends HTMLElement = HTMLElement>({ rippleTimeout, rippleClassNames, rippleContainerClassName, rippleClassName, disableRipple, disableSpacebarClick, ...options }: RipplesOptions<E>): ReturnValue<E>;
export {};
