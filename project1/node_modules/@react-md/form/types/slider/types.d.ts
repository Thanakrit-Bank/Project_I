 ...
 * @remarks \@since 2.5.0
 */
export declare type SliderThumbIndex = ThumbIndex | null;
/**
 * @remarks \@since 2.5.0
 */
 ...
 * @remarks \@since 2.5.0
 */
export declare type SliderDraggingBy = "mouse" | "touch" | null;
/**
 * @remarks \@since 2.5.0
 */
 ...
 * @remarks \@since 2.5.0
 */
export declare type SliderDefaultValue = SliderValue | (() => SliderValue);
/**
 ...
 * @remarks \@since 2.5.0
 */
export declare type RangeSliderValue = readonly [number, number];
/**
 * @remarks \@since 2.5.0
 */
export declare type RangeSliderDefaultValue = RangeSliderValue | (() => RangeSliderValue);
/**
 ...
 * @remarks \@since 2.5.0
 */
export interface SliderThumbOptions extends Omit<SliderValueOptions, "step">, SliderPresentation, SliderThumbPresentation {
}
/**
 * @remarks \@since 2.5.0
 */
export declare type DefinedSliderValueOptions = Required<SliderValueOptions>;
/**
 * @remarks \@since 2.5.0
 */
export declare type SliderEventHandlerNames = "onBlur" | "onKeyDown" | "onMouseDown" | "onTouchStart";
/**
 * @remarks \@since 2.5.0
 */
export declare type SliderEventHandlers = Pick<HTMLAttributes<HTMLSpanElement>, SliderEventHandlerNames>;
/**
 * @remarks \@since 2.5.0
 */
 ...
 * @remarks \@since 2.5.0
 */
export interface BaseSliderProps extends HTMLAttributes<HTMLDivElement>, SliderAddons, SliderLabelProps, SliderPresentation, SliderThumbPresentation {
    /**
