...
function useFixedPositioning(_a) {
    ...
    var updateStyle = (0, react_1.useCallback)(function () {
        ...
        var style = (0, utils_1.getFixedPosition)(__assign({ container: container, element: element, anchor: anchor, disableSwapping: disableSwapping, disableVHBounds: disableVHBounds, initialX: initialX, initialY: initialY, preventOverlap: preventOverlap, transformOrigin: transformOrigin, vhMargin: vhMargin, vwMargin: vwMargin, width: width, xMargin: xMargin, yMargin: yMargin }, getFixedPositionOptions === null || getFixedPositionOptions === void 0 ? void 0 : getFixedPositionOptions())).style;
        setStyle(style);
    ...
    (0, utils_1.useScrollListener)({
        ...
        onScroll: function (event) {
            ...
            if (onScroll && fixedElement && fixedToElement) {
                onScroll(event, {
                    visible: (0, utils_2.isWithinViewport)({ fixedElement: fixedElement, fixedToElement: fixedToElement }),
