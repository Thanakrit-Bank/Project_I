...
/// The amount of padding to place before the first list item and after the last
/// list item in the list.
///
/// @type Number
/// @see rmd-list-dense-vertical-padding
...
/// It is recommended to keep this value at `0` and instead update the
/// `$rmd-list-item-horizontal-padding` instead to get better clickable areas
/// and hover effects on each item.
///
/// @type Number
/// @see rmd-list-dense-horizontal-padding
/// @see rmd-list-item-horizontal-padding
$rmd-list-horizontal-padding: 0 !default;

/// The amount of padding to place to the left and right of all the list items
/// in a "dense" layout. It is recommended to keep this value at `0` and instead
/// update the `$rmd-list-item-horizontal-padding` instead to get better
/// clickable areas and hover effects on each item.
///
/// @type Number
/// @see rmd-list-horizontal-padding
/// @see rmd-list-item-horizontal-padding
$rmd-list-dense-horizontal-padding: $rmd-list-horizontal-padding !default;

/// The line height to apply to all items within the list. The default
/// typography applied to lists uses the `subtitle-1` typography specs, but it
/// looks better to apply the main text line-height within lists.
///
...
/// The amount of vertical padding to apply to each list item. This is really
/// only added to help with the default "growing height" case of items since the
/// list item is aligned using a centered flexbox.
///
/// @type Number
...
/// The default height for a list item. To help create more general lists and
/// layouts this height will be applied as a `min-height` instead of `height` so
/// that it can grow in height based on the content.  When using the `ListItem`
/// component, it will automatically "upgrade" to use `height` when the
/// `secondaryText` or list item "addons" are provided to help enforce the
...
/// The height for a "large" sized list item. This will normally get applied for
/// any list item that has secondary text with no icon, or avatar.
/// @type Number
...
/// The height for an "extra large" sized list item. This will normally get
/// applied for any list item that:
...
/// The line-height to use for the secondary text within the list item. This is
/// different than the primary text since this can span multiple lines by
/// default.
/// @type Number
$rmd-list-item-secondary-text-line-height: 1.42857 !default;
// stylelint-enable number-max-precision

/// The max allowed height for the three-line list item's secondary text. You
/// probably don't want to change this value unless you changed the other list
/// item heights.
/// @type Number
...
/// You probably don't want to change this value unless you changed the other
/// list item heights.
/// @type Number
$rmd-list-item-dense-secondary-text-three-line-max-height: 2.25rem !default;

/// The spacing between the left side of the list item up to the left side of
/// the first character of text. This is normally just used to align the list
/// items with other components.
/// @type Number
$rmd-list-item-text-keyline: 4.5rem !default;

/// The size to use for media that appears before or after the main content in a
/// list item.
/// @type Number
$rmd-list-item-media-size: 3.5rem !default;

/// The size to use for large media that appears before or after the main
/// content in a list item.
/// @type Number
$rmd-list-item-media-large-size: 6.25rem !default;

/// The amount of spacing to place between the main content and media that
/// appears in a list item.
/// @type Number
