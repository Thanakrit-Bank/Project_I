...
exports.SrOnly = (0, react_1.forwardRef)(function SrOnly(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(Typography_1.Typography, __assign({}, props, { ref: ref, tabIndex: tabIndex, component: component, className: (0, classnames_1.default)(block({ focusable: focusable }), className) }, { children: children })));
});
