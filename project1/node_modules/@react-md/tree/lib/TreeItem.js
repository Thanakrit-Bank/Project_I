...
exports.TreeItem = (0, react_1.forwardRef)(function TreeItem(_a, ref) {
    ...
    if (renderChildItems) {
        var icon = ((0, jsx_runtime_1.jsx)(TreeItemExpanderIcon_1.TreeItemExpanderIcon, __assign({ rotated: expanded }, { children: expanderIcon })));
        if (expanderLeft) {
            leftAddon = icon;
        }
        else {
        ...
        group = (0, jsx_runtime_1.jsx)(TreeGroup_1.TreeGroup, __assign({ collapsed: !expanded }, { children: renderChildItems() }));
    }
    ...
    var a11y = __assign(__assign({ "aria-expanded": renderChildItems ? expanded : undefined, "aria-selected": selected, "aria-level": depth + 1, "aria-setsize": listSize, "aria-posinset": itemIndex + 1, "aria-disabled": disabled || undefined, id: id, role: "treeitem", tabIndex: -1 }, handlers), { onFocus: handleFocus });
