def get_data_index(folder_name):
    ...
    # 191(lat) x 253(lon) = 28323 values + 1 date = 28324 index 
    # but if it have date frequency is month data_split_t will have 28324 + 1 month = 28325 index
...
# Get the list of all files and directories "C:\Users\s6201\Downloads\Data_Project"
...
for folder_name in dir_list:
    if(folder_name != 'monthly'):
        # "C:\Users\s6201\Downloads\New folder\data_project"
