...
function useTransition(_a) {
    ...
    var configuration = {
        appear: appear,
        timeout: (0, utils_2.getTransitionTimeout)({ timeout: timeout, appear: appear, enter: enter, exit: exit }),
        reflow: reflow,
        onEnter: onEnter,
    ...
    var configurationRef = (0, react_1.useRef)(configuration);
    configurationRef.current = configuration;
    var _g = __read((0, utils_1.useEnsuredRef)(nodeRef), 2), ref = _g[0], refCallback = _g[1];
    var _h = __read((0, react_1.useReducer)(function reducer(state, action) {
