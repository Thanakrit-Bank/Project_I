...
function useCSSTransition(_a) {
    ...
    var _e = (0, useTransition_1.useTransition)(__assign(__assign({}, options), { appear: appear, enter: enter, exit: exit, timeout: timeout, reflow: true })), ref = _e.ref, stage = _e.stage, rendered = _e.rendered, appearing = _e.appearing, transitionTo = _e.transitionTo;
    ...
    var transitionClassNames = (0, utils_1.getTransitionClassNames)({
        timeout: timeout,
        appear: appear,
        enter: enter,
        exit: exit,
