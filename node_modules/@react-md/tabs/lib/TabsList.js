...
var useTabIndicatorStyles_1 = require("./useTabIndicatorStyles");
var styles = (0, utils_1.bem)("rmd-tabs");
/**
...
exports.TabsList = (0, react_1.forwardRef)(function TabsList(_a, ref) {
    ...
    }), _focusIndex = _h.focusIndex, eventHandlers = __rest(_h, ["focusIndex"]);
    var _j = (0, useTabIndicatorStyles_1.useTabIndicatorStyles)({
        ref: ref,
        activeIndex: activeIndex,
    }), refCallback = _j.refCallback, indicatorStyles = _j.indicatorStyles;
    return ((0, jsx_runtime_1.jsx)("div", __assign({}, props, { "aria-orientation": orientation, style: __assign(__assign({}, style), indicatorStyles), role: "tablist", ref: refCallback, className: (0, classnames_1.default)(styles((_b = {},
            _b[align] = true,
            _b.padded = padded,
