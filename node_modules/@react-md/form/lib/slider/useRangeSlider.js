...
function useRangeSlider(defaultValue, _a) {
    ...
    var _h = __read((0, react_1.useState)([]), 2), hack = _h[1];
    var _j = __read((0, react_1.useState)(defaultValue !== null && defaultValue !== void 0 ? defaultValue : [min, max]), 2), value = _j[0], setValue = _j[1];
    ...
    var update = (0, react_1.useCallback)(function (_a) {
        ...
        setValue(function (_a) {
            var _b = __read(_a, 2), thumb1Value = _b[0], thumb2Value = _b[1];
            var value;
            var minValue = min;
            var maxValue = max;
            if (index === 0) {
    ...
    var persist = (0, react_1.useCallback)(function () {
        var _a = __read(currentValue.current, 2), prev1 = _a[0], prev2 = _a[1];
