...
/// normally want this color to be a bit lighter than the main progress color
...
/// also need to update the `dasharray` prop for the `CircularProgress`
/// component.
/// @type Number
...
/// The starting dashoffset for the circular progress animation. This will be
...
/// The ending dashoffset for the circular progress animation. This will be used
