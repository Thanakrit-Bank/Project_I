...
exports.AppBarAction = (0, react_1.forwardRef)(function AppBarAction(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsx)(button_1.Button, __assign({}, props, { theme: theme, buttonType: buttonType, floating: floating, ref: ref, className: (0, useActionClassName_1.useActionClassName)({ first: first, last: last, inheritColor: inheritColor, className: className }) }, { children: children })));
});
