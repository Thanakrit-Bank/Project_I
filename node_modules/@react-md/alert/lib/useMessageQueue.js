...
function useMessageQueue(_a) {
    ...
    var _e = __read((0, react_1.useReducer)(function (state, action) { return reducer(state, action); }, defaultQueue), 2), queue = _e[0], dispatch = _e[1];
    ...
    var _f = __read((0, utils_1.useToggle)(defaultQueue.length > 0), 3), visible = _f[0], showMessage = _f[1], hideMessage = _f[2];
    var _g = __read((0, utils_1.useTimeout)(hideMessage, timeout), 3), startTimer = _g[0], stopTimer = _g[1], restartTimer = _g[2];
