 ...
 */
export declare type AutoCompletion = "none" | "inline" | "list" | "both";
/**
 ...
 * `"none"` value instead.
 */
export declare type PreconfiguredFilterFunction = "fuzzy" | "case-insensitive" | "none";
/**
 * The filter options provided to the filter function.
 */
export declare type FilterFunctionOptions<O extends {} = {}> = O & CaseInsensitiveOptions<AutoCompleteData>;
/**
 ...
 */
export declare type AutoCompleteFilterFunction<O extends {} = {}> = PreconfiguredFilterFunction | FilterFunction<O>;
/**
...
export interface AutoCompleteProps extends Omit<TextFieldProps, "type">, RenderConditionalPortalProps, AutoCompleteListboxPositionOptions {
    /**
